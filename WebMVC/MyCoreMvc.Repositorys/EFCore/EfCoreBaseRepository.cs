...
using VaCant.Repositorys.EFCore;
...
{
    public class EfCoreBaseRepository<TEntity> : EfCoreBaseRepository<TEntity, long>, IRepository<TEntity> where TEntity : class, IEntity<long>
    {
        public EfCoreBaseRepository(EfCoreBaseDbContext dbContext) : base(dbContext)
        {
    ...
    {
        private readonly EfCoreBaseDbContext _dbContext;
        private readonly IUnitOfWork _unitOfWork;

        public EfCoreBaseRepository(EfCoreBaseDbContext dbContext)
        {
